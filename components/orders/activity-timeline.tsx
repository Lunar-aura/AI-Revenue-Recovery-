...
export function ActivityTimeline({ items }: ActivityTimelineProps) {
  return (
    <div className="rounded-[24px] border border-slate-200 bg-white p-6 shadow-[0_16px_42px_-24px_rgba(15,23,42,0.24)]">
      <div>
        <h2 className="text-xl font-semibold tracking-tight text-slate-950">Recent order activity</h2>
        <p className="mt-1 text-sm text-slate-500">A calm record of fulfillment and customer events.</p>
      </div>
