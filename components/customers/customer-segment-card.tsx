...
const tones: Record<CustomerSegmentCardProps["tone"], string> = {
...
export function CustomerSegmentCard({ label, count, revenue, avgSpend, growth, tone }: CustomerSegmentCardProps) {
  return (
    <div className="group rounded-[18px] border border-slate-200 bg-white p-5 shadow-[0_10px_30px_-20px_rgba(15,23,42,0.16)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_18px_36px_-24px_rgba(15,23,42,0.24)]">
      ...
      <div className="mt-4 grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <p className="mt-1 font-semibold text-slate-900">{avgSpend}</p>
        </div>
      </div>
